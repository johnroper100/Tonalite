...
var app = new Vue({
    ...
    methods: {
        ...
        editEffectSettings: function () {
            socket.emit('editEffectSettings', { fixtureID: app.currentFixture.id, effectID: app.currentEffect.id, name: app.currentEffect.name, depth: app.currentEffect.depth });
        },
